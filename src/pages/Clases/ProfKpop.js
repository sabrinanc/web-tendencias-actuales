        ...
        <main>
            ...
            <div className="first-container">
                ...
                <div className="container    reveal">
                    ...
                    <h1 className="title">Profesorado de<br></br><b>k-pop dance</b></h1>
                    <p>
                    Adquirí la técnica necesaria para interpretar los dancecovers de tus boybands y girlbands favoritas,  y la formación pedagógica para dictar clases en distintos contextos y para diferentes grupos.    
                    </p>
                    
                    <p>
                        <i className="fa-solid fa-graduation-cap"></i> Título: <b>PROFESOR SUPERIOR DE K-POP DANCE</b><br></br>
                    ...
                    <HashLink smooth to="/profesorado-kpop-dance#propuesta">Propuesta</HashLink>
                    <HashLink smooth to="/profesorado-kpop-dance#plan-de-estudios"> | Plan de estudios</HashLink>
                    <HashLink smooth to="/profesorado-kpop-dance#staff"> | Staff</HashLink>
                    <HashLink smooth to="/profesorado-kpop-dance#faq"> | Preguntas frecuentes</HashLink>
            ...
            <img src="/img/portada-profesorado-kpop.jpg" alt="banner" className="img-br"></img>
            ...
            <br></br>
            <br></br>
            <img src="/img/portada-clases-kpop.jpg" alt="banner" className="img-br"></img>
                ...
                <div className="container  reveal">
                    ...
                    <details id="instancias-examen">
                        ...
                        <p>
                            ...
                            <ul>
                                <li>☑ K-Pop  I - Historia, Dancecovers boybands y girlbands</li>
                                ...
                                <li>☑ Prácticas docentes I - Instructorado de K-pop y Hip-Hop</li>
                            </ul>

                            <i className="fa-solid fa-graduation-cap"></i> Título: <b>INSTRUCTOR DE K-POP Y HIP-HOP DANCE</b><br></br>
                    ...
                    <details id="instancias-examen">
                        ...
                        <p>
                            ...
                            <ul>
                                <li>☑ K-Pop  II - Dancecovers boybands y girlbands</li>
                                ...
                                <li>☑ Prácticas docentes II - Profesor elemental de K-Pop Dance</li>
                            </ul>

                            <i className="fa-solid fa-graduation-cap"></i> Título: <b>PROFESOR ELEMENTAL DE K-POP DANCE</b><br></br>
                    ...
                    <details id="instancias-examen">
                        ...
                        <p>
                            ...
                            <ul>
                                <li>☑ K-Pop  III - Dancecovers boybands y girlbands</li>
                                ...
                                <li>☑ Prácticas docentes II - Profesor superior de K-Pop Dance</li>
                            </ul>
            ...
            <img src="/img/portada-clases-kpop2.jpg" alt="banner" className="img-br"></img>
